...
<html lang="en">
    ...
    <body>
        ...
        <h2>Create New Dock Record</h2>
        <form action="create" method="get">

            
            HIN: <input type="text" name="email" size="30"  
                          placeholder="Enter the ship's HIN/CIN" required>
            <br><br>

           
            Dock Number: <input type="number" name="bloodsugar" value='120' required>
            <br><br>
            
            Date: <input type="text" name="date" id="datepicker" size="30">
            <br><br>
           
            <!--Created Drop down menu to select ship's nationality-->
            Nationality: 
